        ...
        <table style="width: 564px; height: 572px;" border="0">
			...
			<tr>
             <td style="width: 85px">
                    ...
                    项目状态：</td>
               <td style="width: 155px">
                    <asp:TextBox ID="zt" runat="server" Width="325px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 85px">项目备注：</td>
                <td style="width: 155px">
                    <asp:TextBox ID="beizhu" runat="server"  TextMode="MultiLine" Height="300px" Width="325px"></asp:TextBox></td>
            </tr>
			<tr>
