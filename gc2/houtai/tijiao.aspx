<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tijiao.aspx.cs" Inherits="Bedrock_tijiao" %>
        ...
        <table align="center" style="height: 376px" class=css border="6" bordercolordark="#9999999" bordercolorlight="#ffffff" cellspacing="0">
			...
			<tr>
              <td align="right" style="width: 149px"    >
                    ...
                    预算：</td>
              <td style="width: 334px" align="left" ><asp:TextBox ID="yusuan" runat="server" Width="116px"></asp:TextBox></td>
            </tr>
			...
			<tr>
              <td align="right" style="width: 149px"    >
                    ...
                    费用：</td>
              <td style="width: 334px" align="left" > <asp:TextBox ID="shu" runat="server" Width="325px"></asp:TextBox>元
